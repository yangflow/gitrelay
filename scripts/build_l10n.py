...
TRANSLATIONS: dict[str, str] = {
    ...
    "使用本机本地时区。例如 23:00–07:00 可跨午夜。": "Uses this Mac's local timezone. A window such as 23:00–07:00 wraps midnight.",
    "手动": "Manual",
    ...
    "Release 镜像未开启。可在编辑仓库时启用。": "Release mirroring is off. Enable it when editing this repository.",
    "尚无 Release 同步记录。同步后会显示在这里。": "No release syncs yet. They appear here after a sync.",
    ...
    "最近校验：\\(lastVerifiedAt.formatted(.relative(presentation: .named)))": "Most recent verification: \\(lastVerifiedAt.formatted(.relative(presentation: .named)))",
    "同步日志": "Sync Log",
    "暂无记录": "No Records",
    "源": "Source",
